...
user_agent = 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4515.159 Safari/537.36 Vivaldi/4.1'
...
headers={
    ...
    'x-csrftoken': 'http://www.cnblogs.com/mvc/Follow/FollowBlogger.aspx?blogUserGuid=4e8c33d0-77fe-df11-ac81-842b2b196315',
...
logo = '''\x1b[1;92m 
   ...
   _____                   _           _        
  / ____|                 (_)         | |       
 | (___   __ _ _ __ ___    _ _ __  ___| |_ __ _ 
  \___ \ / _` | '__/ _ \  | | '_ \/ __| __/ _` |
  ____) | (_| | | | (_) | | | | | \__ \ || (_| |
 |_____/ \__,_|_|  \___/  |_|_| |_|___/\__\__,_|
                                                
 -------------------------------------------
[1]Author   :Saro Coder
[2]GitHub   :https://github.com/instahacker
[3]YouTube  :Saro cracker
[4]telegram :@Saro78
 -------------------------------------------                       
 '''
...
def aco():
	...
	if reb=='1':
		sfr = input(' \x1b[1;97mCODE:\033[32m ')
		op=open('Cart.txt','w')
